conditional_ddpm.py is provided by Sasaki Hikaru sensei. As an example of conditional denoising diffusion probabilistic model applied on sine regression work.
